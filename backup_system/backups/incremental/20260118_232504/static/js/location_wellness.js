...
document.addEventListener('DOMContentLoaded', function() {
    ...
    let autoTrackingEnabled = true; // Auto-tracking enabled by default
    ...
    function startLocationTracking() {
        ...
        try {
            ...
            speakText("Location tracking started. You will receive mindful eating alerts when near food locations.");
    ...
    function updateLocation(position) {
        ...
        .then(data => processLocationResponse(data, currentTime))
        .catch(error => {
        ...
        function processLocationResponse(data, currentTime) {
            ...
            if (data.status === 'active' && data.restaurant_name && 
                (currentTime - lastAlertTime > ALERT_COOLDOWN || isRaisingCanes)) {
